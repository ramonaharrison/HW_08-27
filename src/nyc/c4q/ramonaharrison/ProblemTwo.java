 ...
 * The method should then calculate the two possible ages based on that year, and return
 * the result in the following format: (replacing 'NN' with the possible years) : "You are either NN or NN."
 */
